...
// 			Debug.Log(loaddir);
	...
	void winMenuToolbar(int id)
	{
		...
		else nSetIndex	= GUI.SelectionGrid(FXMakerLayout.GetChildVerticalRect(FXMakerLayout.GetMenuToolbarRect(), 0, 10, 0,10), Mathf.Min(m_nBackgroundIndex, m_nBackgroundCount-1), m_BackgroundContents, m_BackgroundContents.Length);
...
// 			}
	...
	void ShowRightMenu(int nObjectIndex, bool bSelected)
	{
		...
		FxmPopupManager.inst.ShowMenuPopup(new string[]{"PingPrefab", "-", "New", "Delete", "Clone", "Thumb"},
