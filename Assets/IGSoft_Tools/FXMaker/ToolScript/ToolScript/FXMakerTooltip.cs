	...
	protected static string[,]	HsScriptMessage = {
								{
									...
									,"- Printable Material does not exist." + "\n" +
...
// 			case "BACKGROUND_HOVER"		: tooltip = arg + "\n" + helpStr[GetLang(), 3]		+ AddHintRect(FXMakerBackground.GetRect_Resources); break;
	...
	protected static GUIContent[] HcToolEffect_Camera;
	public static GUIContent[] GetHcToolEffect_Camera()
	{
		if (HcToolEffect_Camera == null)
		{
			HcToolEffect_Camera = new GUIContent[4];
			HcToolEffect_Camera[0]	= GetGUIContent("Top"	, "Top View" + AddHintRect(FXMakerLayout.GetClientRect));
			HcToolEffect_Camera[1]	= GetGUIContent("HighQ"	, "High Quarter View (90)" + AddHintRect(FXMakerLayout.GetClientRect));
			HcToolEffect_Camera[2]	= GetGUIContent("Back"	, "Back View" + AddHintRect(FXMakerLayout.GetClientRect));
			HcToolEffect_Camera[3]	= GetGUIContent("LowQ"	, "Low Quarter View (40)" + AddHintRect(FXMakerLayout.GetClientRect));
		}
		return HcToolEffect_Camera;
	}
	...
	protected static string[,]	HsEditor_NcCurveAnimation = {
								{
									...
									,"- After m_fDurationTime elapses, remove GameObject."
	...
	protected static string[,]	HsEditor_NcSpriteAnimation = {
								{
									...
									,"- GameObject will be deleted afet Animation ends." + "\n" +
	...
	protected static string[,]	HsEditor_NcAutoDestruct = {
								...
								,
								{
									...
									,"- true: 소멸되는 시간동안 'ParticleSystem의 Emission'을 정지 시킨다." + "\n" +
									 "- 더 이상 파티클은 생성되지 않는다."
									,"- true: 소멸되는 시간동안 Material의 alpha값을 감소 시킨다.(단, Alpha가 있는 material에만 적용 된다)"
