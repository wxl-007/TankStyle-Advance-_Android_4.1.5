...
// 		NgUtil.LogMessage("ToolMessage - " + msg);
	...
	public void ShowMenuPopup(string[] displayedMenu)
	{
		ShowMenuPopup(displayedMenu, null);
	}

	public void ShowMenuPopup(string[] displayedMenu, bool[] eabledMenu)
	{
		...
		{
			if (eabledMenu == null)
				 m_CurrentMenuPopup.ShowPopupWindow(displayedMenu);
			else m_CurrentMenuPopup.ShowPopupWindow(displayedMenu, eabledMenu);
		}
	}
